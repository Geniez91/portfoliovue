  ...
  <div class="mx-3 my-5">
      ...
      <v-form>
        <div class="my-2">
          ...
          <v-text-field
            type="text"
            v-model="nameProjet"
            @update:model-value="nameProjet = $event"
            :rules="[emptyRules]"
          >
          </v-text-field>
        </div>
        ...
        <div class="my-2">
          ...
          <v-number-input v-model="nbCollaborator"></v-number-input>
        </div>
    ...
    <div>
      ...
      <div class="d-flex justify-center">
        <v-btn color="info" prepend-icon="mdi-plus" class="my-5" @click="addProjectHandler"
          >Ajouter</v-btn
        >
      </div>
    </div>
