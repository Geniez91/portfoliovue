  ...
  <div class="mx-3 my-5">
      ...
      <v-form>
        <div class="my-2">
          ...
          <v-text-field
            type="text"
            v-model="nameCompany"
            @update:model-value="nameCompany = $event"
            :rules="[emptyRules]"
          >
          </v-text-field>
        </div>
        ...
        <div class="my-2">
          ...
          <div class="d-flex">
            <v-date-input
              ...
              class="mr-5"
            ></v-date-input>
            <v-date-input v-model="endDate" label="End Date" :min="startDate"></v-date-input>
          </div>
        </div>
    ...
    <div>
      ...
      <div class="d-flex justify-center">
        <v-btn color="info" prepend-icon="mdi-plus" class="my-5" @click="addWorkExperienceHandler"
          >Ajouter</v-btn
        >
      </div>
    </div>
