  ...
  <div class="mx-3 my-5">
    ...
    <v-card class="my-3 px-3">
      <v-form>
        <div class="my-2">
          ...
          <v-text-field
            type="text"
            v-model="currentWorkExperience.nameCompany"
            @update:model-value="currentWorkExperience.nameCompany = $event"
            :rules="[emptyRules]"
          >
          </v-text-field>
        </div>
        <div class="my-2">
          <p>Emploi :</p>
          <v-text-field type="text" v-model="currentWorkExperience.job" :rules="[emptyRules]">
          </v-text-field>
        </div>
        ...
        <div class="my-2">
          ...
          <div ref="divTasks">
            <v-text-field
              v-for="(task, index) in currentWorkExperience.tasks"
              :key="index"
    ...
    <div>
      ...
      <div class="d-flex justify-center">
        <v-btn
          class="my-5"
          @click="addWorkExperienceHandler"
          color="warning"
...
function findWorkExperience() {
  const found = workExperiences.value.find((exp) => exp.id?.toString() === route.params.id)
  if (!found) {
