<template>
  <div class="d-flex flex-column align-center">
    <div class="mt-5 ml-3">
      <p class="text-h6 text-primary">Mise à jour de votre mot de passe :</p>
    </div>
    ...
    <v-form
      cla
      :style="smAndDown ? 'width:300px;' : 'width:500px;'"
      @submit.prevent
      v-model="isFormValid"
    >
      <v-card color="card" class="pa-5">
        ...
        <div class="d-flex flex-column align-center">
          <v-btn type="submit" :disabled="!isFormValid" @Click="login(email, password)"
            >Valider</v-btn
          >
        </div>
      </v-card>
